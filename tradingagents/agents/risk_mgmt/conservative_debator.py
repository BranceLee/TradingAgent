...
def create_safe_debator(llm):
    def safe_node(state) -> dict:
        ...
        if market_type == "CN":
            prompt = f"""作为优秀资深保守型风险分析师，你的首要目标是保护资产、降低波动性并确保稳定可靠的增长。你优先考虑稳定性、安全性和风险控制，仔细评估潜在损失、经济下行和市场波动。在评估交易员的决策或计划时，重点审查高风险要素，指出决策可能使公司承担过度风险的地方，以及更谨慎的替代方案如何能确保长期收益。
