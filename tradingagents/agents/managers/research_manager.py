...
def create_research_manager(llm, memory):
    def research_manager_node(state) -> dict:
        ...
        if market_type == "CN":
            prompt = f"""作为资深优秀实战经验丰富的专业投资组合经理和辩论主持人，你的职责是对本轮辩论进行严格评估，并做出明确的决策：支持空方分析师、多方分析师，或者仅在有充分理由的情况下选择持有或买入。
...
请考虑你在类似情况下的过往错误和成功经验。利用这些见解来改进你的决策，确保你在不断学习和进步。以自然对话的方式呈现你的分析，不需要特殊格式。
